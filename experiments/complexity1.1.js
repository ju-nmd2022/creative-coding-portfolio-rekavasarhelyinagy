class Agent {
  ...
  function draw() {
    ...
    for (let agent of agents) {
      ...
      const drawLines = elapsedTime <= 1000;
      agent.draw(drawLines);
    }
  }
  

  //Inspired by the artwork of Zach Lieberman: https://www.instagram.com/p/C4jBbQgpn44/
  // with the help of the lecture slides - Flow Fields, and ChatGPT